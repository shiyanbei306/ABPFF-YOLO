...
def parse_opt():
    ...
    parser.add_argument('--weight', type=str, default=r'D:\code\yolov8-20230904\yolov8-main\runs\train\n-voc-aux\weights\best.pt', help='training model path')
    parser.add_argument('--data', type=str, default='ultralytics/datasets/VOC.yaml', help='data yaml path')
    ...
    parser.add_argument('--save_json', default=True, help='save results to JSON file')
