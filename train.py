...
def parse_opt():
    ...
    parser.add_argument('--yaml', type=str, default='ultralytics/models/v8/yolov8n-aux.yaml', help='model.yaml path')
    ...
    parser.add_argument('--name', type=str, default='n-voc-aux', help='save to project/name')
